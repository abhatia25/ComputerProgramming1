Public Class frmMasterBedroom
    ...
    Private Sub frmMasterBedroom_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        lblCandyCounter.Text = "Candy Counter:" & vbCrLf & "4"
        MessageBox.Show("You have now entered the Master bedroom, find the candy by clicking diffrent objects. YOU HAVE A TIME LIMIT, GO")
        Timer1.Start()
    End Sub

    Private Sub btnButton12_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCandy.Click
        btnCandy.BackgroundImage = My.Resources.Hershys
        intCandyCounter = 4
        Timer1.Stop()
    ...
    Private Sub btnButton7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnButton7.Click
    ...
    Private Sub btnButton6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnButton6.Click
        If shakeCount >= 1000 Then
            shakeCount = 0
        End If
    ...
    Private Sub btnButton13_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnButton13.Click
        If shakeCount >= 1000 Then
            shakeCount = 0
        End If
    ...
    Private Sub btnButton14_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnButton14.Click
        If shakeCount >= 1000 Then
            shakeCount = 0
        End If
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If ProgressBar1.Value = 100 Then
            ...
            MessageBox.Show("You did not find the candy in time, dead Gandma found you. GAME OVER")
            Me.Visible = False
